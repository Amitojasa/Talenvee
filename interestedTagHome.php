...
<?php 
                            $queryf=mysqli_query($conn,"select interests from userdetailstb where id=$lUserId") or die(error_page());
                            $rf=mysqli_fetch_assoc($queryf)['interests'];
                                    ...
                                    <div class="comments" id="commentsSec<?php echo $pid;?>">
                                        ...
                                        <form method="POST">
                                            <div class="row">
                                                <!-- <div class="col-sm-12"> -->
                                                <div class="col-sm-11">
                                                    <textarea class="mention form-control" id="commentValSec<?php echo $pid;?>" rows="1" placeholder="Add a comment" ></textarea>
                                                    </div>
